...
quad_params = {
    ...
    'k_eta': 3.5e-08,           # thrust coefficient N/(rad/s)**2
    'k_m':   7.8e-10,           # yaw moment coefficient Nm/(rad/s)**2
    'k_d':   2.09e-06,       # rotor drag coefficient N/(rad*m/s**2) = kg/rad
    'k_z':   1.34e-05,         # induced inflow coefficient N/(rad*m/s**2) = kg/rad
